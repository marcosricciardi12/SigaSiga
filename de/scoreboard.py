...
class ImageGenerator(QMainWindow):
    ...
    # Crear una nueva imagen con el fondo verde
        ...
        imagenes_textos = [
            ...
            # {'tipo': 'texto', 'posicion': ((1920/2)-(928/2), 1080-50-75), 'contenido': {'texto': self.current_time.text(), 'color': 'white', 'fuente': 'arial.ttf', 'tamaño_fuente': 64}}
]
        ...
        imagen.save('../flask/test_frame.png')  # Guardar la imagen generada
